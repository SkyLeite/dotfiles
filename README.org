...
| {{{mod}}}+d           | "rofi -combi-modi window,drun,ssh -show combi" | Runs rofi in combined mode                       |
| {{{mod}}}+h           | focus left                                     |                                                  |
| {{{mod}}}+j           | focus down                                     |                                                  |
| {{{mod}}}+k           | focus up                                       |                                                  |
| {{{mod}}}+l           | focus right                                    |                                                  |
...
| {{{mod}}}+b           | split h                                        | Splits horizontally                              |
| {{{mod}}}+v           | split v                                        | Splits vertically                                |
| {{{mod}}}+f           | fullscreen toggle                              | Toggles fullscreen mode for the focused window   |
| {{{mod}}}+s           | layout stacking                                | Sets layout to stacking                          |
| {{{mod}}}+w           | layout tabbed                                  | Sets layout to tabbed                            |
| {{{mod}}}+e           | layout toggle split                            | Toggles layout to split                          |
| {{{mod}}}+Shift+space | floating toggle                                | Toggles floating for the current window          |
| {{{mod}}}+space       | focus mode_toggle                              | Change focus between tiling and floating windows |
| {{{mod}}}+a           | focus parent                                   | Focuses the parent window                        |
| {{{mod}}}+Shift+c     | reload                                         | Reloads the configuration file                   |
| {{{mod}}}+Shift+r     | restart                                        | Restarts i3 in place                             |
| {{{mod}}}+r           | mode "resize"                                  | Toggles resize mode                              |
